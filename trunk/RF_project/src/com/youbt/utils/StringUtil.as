...
public class StringUtil
{
    ...
    public static function substitute(str:String, ... rest):String
    {
		 ...
		 * 
		 */		
		static public function createColorHtml(value:String, color:String) : String
        {
            if (color.charAt() != "#")
            {
                color = "#" + color;
         ...
         * 
         */        
        static public function createASFunctionTag(func:String, value:String, param:String,guid:String = "") : String
        {
            return "<a href=\"event:" + func + "," + param + "," + guid + "\">" + value + "</a>";
        }
         ...
         * 
         */        
        static public function clearHtml(value:String) : String
        {
            ...
            {
                returnValue = returnValue + list[index].substr(list[index].indexOf(">") + 1);
            }
            return returnValue;
        }
