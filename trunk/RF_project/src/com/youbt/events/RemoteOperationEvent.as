package com.youbt.events
{
	...
	public class RemoteOperationEvent extends Event
	{
		 ...
		 * 成功 
		 */
		public static const REMOTE_OPERATION_SUCCESED:String = 'rf_framework_remote_operation_succesed';
		
		/**
		 * 完全错误 
		 */
		public static const REMOTE_OPERATION_FAULT:String = 'rf_framework_remote_operation_fault';
		
		/**
		 *数据出错 
		 */
		public static const REMOTE_OPERATION_DATA_FAILED:String= 'rf_framework_remote_operation_data_progress_failed';
