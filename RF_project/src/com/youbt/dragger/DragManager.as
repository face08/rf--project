package com.youbt.dragger{
	...
	public class DragManager{
		...
		public static var DEFAULT_DROP_MOTION:IDropMotion = new DirectlyRemoveMotion();
		public static var DEFAULT_REJECT_DROP_MOTION:IDropMotion = new RejectedMotion();
		
		private static var s_isDragging:Boolean = false;
		
		private static var s_dragListener:IDragListener;
		private static var s_dragInitiator:AbstractDragger;
		...
		private static var enteredComponent:AbstractDragger;
		 ...
		 */
		public static function startDrag(dragInitiator:AbstractDragger, sourceData:SourceData, dragImage:IDraggingImage=null, dragListener:IDragListener=null):void{
			if(s_isDragging){
			...
			var globalPos:IntPoint = new IntPoint(stage.mouseX,stage.mouseY);
			...
			mouseOffset = new Point(container.mouseX - dp.x, container.mouseY - dp.y);
		...
		public static function removeDragListener(lis:IDragListener):void{
			ArrayUtil.remove(listeners, lis);
		}
		...
		public static function getDropTargetComponent(pos:Point=null):AbstractDragger{
			return getDropTarget(curStage, pos, AbstractDragger) as AbstractDragger;
		}
		 ...
		 * @see #getDropTargetComponent()
		 */
		public static function getCurrentDropTargetComponent():AbstractDragger{
			return getDropTarget(curStage, null, AbstractDragger) as AbstractDragger;
		}
		 ...
		 */
		public static function getDropTragetDropTriggerComponent(pos:Point=null):AbstractDragger{
			return getDropTarget(
				curStage, 
				pos, 
				AbstractDragger, 
				____dropTargetCheck) as AbstractDragger;
		}
		 ...
		 * @see #getDropTargetDropTriggerComponent()
		 */
		public static function getCurrentDropTargetDropTriggerComponent():AbstractDragger{
			return getDropTarget(
				curStage, 
				null, 
				AbstractDragger, 
		...
		private static function ____dropTargetCheck(tar:AbstractDragger):Boolean{
		...
		private static function onMouseMove(mx:Number, my:Number):void{
			...
			var dropC:AbstractDragger = getCurrentDropTargetDropTriggerComponent();
		...
		private static function drop():void{
			...
			var globalPos:IntPoint =new IntPoint(curStage.mouseX,curStage.mouseY);
		...
		private static function fireDragStartEvent(dragInitiator:AbstractDragger, sourceData:SourceData, pos:IntPoint):void{
			...
			for(var i:int=0; i<listeners.length; i++){
				var lis:IDragListener = listeners[i];
				lis.onDragStart(e);
			}
		}
		
		private static function fireDragEnterEvent(dragInitiator:AbstractDragger, sourceData:SourceData, pos:IntPoint, targetComponent:AbstractDragger, relatedTarget:AbstractDragger):void{
			var e:DragAndDropEvent = new DragAndDropEvent(
		...
		private static function fireDragOverringEvent(dragInitiator:AbstractDragger, sourceData:SourceData, pos:IntPoint, targetComponent:AbstractDragger):void{
			var e:DragAndDropEvent = new DragAndDropEvent(
				DragAndDropEvent.DRAG_ENTER, 
				dragInitiator, 
				sourceData, 
		...
		private static function fireDragExitEvent(dragInitiator:AbstractDragger, sourceData:SourceData, pos:IntPoint, targetComponent:AbstractDragger, relatedTarget:AbstractDragger):void{
			var e:DragAndDropEvent = new DragAndDropEvent(
				DragAndDropEvent.DRAG_ENTER, 
				dragInitiator, 
				sourceData, 
		...
		private static function fireDragDropEvent(dragInitiator:AbstractDragger, sourceData:SourceData, pos:IntPoint, targetComponent:AbstractDragger):void{
			var e:DragAndDropEvent = new DragAndDropEvent(
				DragAndDropEvent.DRAG_ENTER, 
				dragInitiator, 
				sourceData, 
