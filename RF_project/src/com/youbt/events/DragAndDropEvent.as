package com.youbt.events{
	...
	import com.youbt.dragger.SourceData;
	import com.youbt.dragger.AbstractDragger;
	...
	public class DragAndDropEvent extends Event{
		...
		private var dragInitiator:AbstractDragger;
		private var sourceData:SourceData;
		private var mousePos:IntPoint;
		private var targetComponent:AbstractDragger;
		private var relatedTargetComponent:AbstractDragger;
		...
		public function DragAndDropEvent(type:String, 
			dragInitiator:AbstractDragger, sourceData:SourceData, mousePos:IntPoint, 
			targetComponent:AbstractDragger=null, relatedTargetComponent:AbstractDragger=null){
		 ...
		 */
		public function getDragInitiator():AbstractDragger{
		 ...
		 * </p>
		 */
		public function getTargetComponent():AbstractDragger{
		 ...
		 * </p>
		 */
		public function getRelatedTargetComponent():AbstractDragger{
